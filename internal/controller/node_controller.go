...
func (r *NodeReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	r.EventRecorder.Eventf(upCopy.ObjectReference(), corev1.EventTypeNormal, "NodeRebootVerified",
		"Node %s rebooted successfully, transitioned to %s", node.Name, terminalState)
...
func (r *NodeReconciler) SetupWithManager(mgr ctrl.Manager) error {
	if r.EventRecorder == nil {
		r.EventRecorder = mgr.GetEventRecorderFor("node-controller")
	}
